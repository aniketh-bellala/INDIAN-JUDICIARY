...
<body>
    ...
    <div class="content">
        ...
        <?php
          $sql_schedule = "SELECT A.Date,A.Time,A.Court_Hall_Number,A.Case_ID,A.Hearing_By FROM COURT_SCHEDULE A, CASE_DETAILS B WHERE A.Case_ID=B.Case_ID and A.Hearing_By='$_SESSION[judge]';";
