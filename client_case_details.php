...
<body>
    ...
    <div class="content">
        ...
        $sql_schedule = "SELECT A.Case_ID,A.Prosecutor,A.Prosecutor_Client,A.Accussor,A.Accussor_Client from CASE_DETAILS A, CLIENTS B where (A.Prosecutor_Client=B.Client_ID or A.Accussor_Client=B.Client_ID) and B.Aadhaar_ID=$_SESSION[aadhaar] ;";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <form action="./client_case_info.php" class="row_flex" method="post">
                                <?php echo '
                                <input type="hidden" name="case_id" value=\'' . $rows["Case_ID"] . '\'>
                                <button type="submit" class="btn btn-warning btn-sm" name="details" onclick="location.href = \'./client_case_info.php\';">More Details</button>'; ?>
                            </form>
                        </td>
                    </tr>
                <?php
