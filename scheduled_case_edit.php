        ...
        ?>
            ...
            ?>
                <form action="./edit_case.php" method="post">
                    ...
                    <select name="verdict">
                        <option value="Judgement Given">Judgement Given</option>
                ...
                <a href="./judge_scheduled.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Go Back!</a>
        <?php
            }
        }
        ?>
