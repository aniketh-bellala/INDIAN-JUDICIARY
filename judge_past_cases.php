...
$sql_pending = "SELECT * from CASE_RECORDS where Final_Verdict like 'Judgement Given' and Hearing_By='$_SESSION[judge]';";
...
<body>
    ...
    <div class="content">
        <h3 class="title2">Past Case Records</h3>
        <br>
