...
<head>
    ...
    <title>Chief Justice Profile</title>
...
<body>
    ...
    $query = "SELECT * from BIODATA where Aadhaar_ID = $_SESSION[admin];";
    $query1 = "SELECT Judge_ID from JUDGES where Aadhaar_ID = $_SESSION[admin];";
                        ...
                        <div class="card">
                            <div class="card-body box">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="./images/chief_justice.png" alt="Admin" class="rounded-circle" width="150" height="150px">
                                    <div class="mt-3">
                                        <h4><?php
                                            echo $fName_fetched;
                                        ?></h4>
                                        <p class="text-secondary mb-1">Chief Justice</p>
                                    </div>
                                    <?php
                                            echo $judge_fetched;
                                            ?>
