...
<title>Chief Justice Welcome</title>
...
<?php
    ...
    $query = "SELECT Full_Name from BIODATA where Aadhaar_ID = $_SESSION[admin];";
...
<div class="top-header">
  ...
  <header class="bg-gradient" id="home">
      <div class="title2">
        <h1><?php echo "Welcome"?><br></h1> <h1><?php echo "Chief Justice  $jud "?></h1>
        <p class="text">
        </p>
      </div>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-4">
            <div class="card features">
                <div class="card-body">
                    <div class="media">
                        <span class="ti-plus gradient-fill ti-3x mr-3"></span>
                        <div class="media-body">
                        <a href="crud_laws.php"><h4 class="card-title">Add Law</h4></a>
