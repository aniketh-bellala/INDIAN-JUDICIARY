var sorTablejs = function (a) {
  ...
  function e(a) {
    for (var b = [], c = 1, d = a.length; c < d; c++)
      for (var e = 0, f = a[c].cells.length; e < f; e++)
        "undefined" == typeof b[c] && ((b[c] = {}), (b[c].key = c)),
          (b[c][e] = a[c].cells[e].innerText);
    return b;
  }
  function f(a, b, c) {
    return (
  ...
  return (
    ...
    window.addEventListener(
      ...
      function () {
        var a = document
          .querySelector(b.targetTable)
          .querySelectorAll(b.selectorHeaders);
        document.querySelector(b.targetTable).classList.add(b.cssBg),
