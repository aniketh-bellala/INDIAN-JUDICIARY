...
<body>
    ...
    $query = "SELECT A.Aadhaar_ID,A.Full_Name,A.Date_Of_Birth,A.Address,A.Mobile_Number,A.Email_ID,B.Court_ID from BIODATA A,(SELECT Aadhaar_ID,Court_ID from JUDGES where Judge_ID = '$_SESSION[judge]') B WHERE A.Aadhaar_ID=B.Aadhaar_ID;";
                        ...
                        <div class="card">
                            <div class="card-body box">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="./images/judge.png" alt="Admin" class="rounded-circle" width="150" height="150px">
                                    <div class="mt-3">
                                        <h4><?php
                                            echo $fName_fetched;
                                            ?></h4>
                                        <p class="text-secondary mb-1">Judge</p>
