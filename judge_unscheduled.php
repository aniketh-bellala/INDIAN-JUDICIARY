...
$sql_pending = "SELECT * from CASE_RECORDS where Final_Verdict like 'Unscheduled' and Hearing_By='$_SESSION[judge]';";
...
<body>
    ...
    <div class="content">
        <h3 class="title2">Unscheduled Case Records</h3>
        <br>
                    ...
                    <tr>
                        ...
                        <td scope="row" class="row_flex cntr">
                            ...
                            <form action="./edit_case.php" method="post">
                                <?php echo '
                                <input type="hidden" name="case_id" value=\'' . $rows["Case_ID"] . '\'>
                                <button type="submit" class="btn btn-warning btn-sm" name="modify_case" onclick="location.href = \'./edit_case.php\';">Edit</button>'; ?>
                            </form>
    ...
    <div id="sub-footer" class="ftr_btm">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <div class="copyright">
