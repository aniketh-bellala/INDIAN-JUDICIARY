...
<body>
    ...
    <div class="content" id="content_id">
        ...
        if (isset($_POST['delete_form'])) {
            $cl = $_POST['clause_delete'];
            $ch = $_POST['ch_delete'];
            $sd = $_POST['sd_delete'];

            if ((!empty($cl)) && (!empty($ch)) && (!empty($sd))) {
                $sql_law = "DELETE from LAWS where Section_Division like '" . $sd . "';";
        ...
        if ($insert) {
            echo "<p style=\"color:green\">Law Deleted!</p>";
        ?>
            <br>
        ...
        ?>
            <form action="./delete_law.php" method="post">
                ...
                <input type="text" readonly="readonly" name="ch_delete" value=<?php echo $default_ch ?>>
                <label><strong>Section & Division</strong></label>
                <input type="text" readonly="readonly" name="sd_delete" value=<?php echo $default_sd ?>>
                <label><strong>Clause</strong></label>
                <textarea name="clause_delete" readonly="readonly"><?php echo $default_cl; ?></textarea>
                <input type="submit" value="Delete" class="btn" name="delete_form" style="background-color:purple;" onclick="return confirm('Are you sure you want to delete?');">
            </form>
            <a href="./crud_laws.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Go Back!</a>
        <?php
        }
